...
abstract class Form
{
    ...
    /**
     * @var array Opciones que influyan en los atributos del formulario al generar sus campos
     */
    ...
    public function __construct($formId, $opciones = array() )
    {
        ...
        //Necesario para coger las opciones por copia
        $formOptionsObj = new ArrayObject($opciones);
        $this->formOptions = $formOptionsObj->getArrayCopy();//array($opciones);//Guardamos las opciones


        $opcionesPorDefecto = $opciones;//array( 'action' => null, );
