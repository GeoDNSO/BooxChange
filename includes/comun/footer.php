...
<div class="footerTotal">
    ...
    <div class="footerSvg">
        <div class="footerSvgSvg">
            <a href="https://lh3.googleusercontent.com/proxy/-MtHXR1ZpSzZ38GQOhbwnKbnQpWRdwz7IC8mV5M70f5YMRbJ-fco2TK5mDBZE8BVeWwREY0bckXUGeaaQp35zarh_tvKXLcxUvrpDs-hvz_8narFv5AxoTm1PMlY1y6PSppKCZOkp2XoTNgGzVetpa-ProbX77Vc4zQ-fYSN">
                <svg class="" viewBox="0 0 24 24"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12zm5.47-16.231c.602.148 1.077.583 1.237 1.136C19 9.908 19 12 19 12s0 2.092-.293 3.095c-.16.553-.635.988-1.238 1.136C16.38 16.5 12 16.5 12 16.5s-4.378 0-5.47-.268c-.602-.149-1.077-.584-1.237-1.137C5 14.092 5 12 5 12s0-2.092.293-3.095c.16-.553.635-.988 1.237-1.136C7.622 7.5 12 7.5 12 7.5s4.378 0 5.47.269zM14.226 12l-3.659-1.9v3.8l3.66-1.9z" fill="#FFF"></path></svg>
            </a>
        </div>

        <div class="footerSvgSvg">
            <a href="https://files.alerta.rcnradio.com/alerta_bogota/public/2019-08/meme_de_lna_mujer_gritando_y_el_gato_en_la_mesa.jpg">
    ...
    <div class="footerA">
        ...
        <div class="footerBox">
            <a href="terminosDeUso.php"> Terminos de uso </a>
        </div>
