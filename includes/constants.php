...
//Constantes para la tabla de Chat

define("BD_CHAT_ID_CHAT", "Id_Chat");
define("BD_CHAT_ID_USER1", "Id_Usuario1");
define("BD_CHAT_ID_USER2", "Id_Usuario2");
...
define("BD_MENSAJE_CHAT_ID_MENSAJE_CHAT", "Id_Mensaje_Chat");
