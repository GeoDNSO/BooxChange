...
?><div class="big-border">
    ...
    <article id="content">
        ...
        <div class="">
         ...
         <p class="pdcp"> En esta web se utilizan cookies de terceros y propias para conseguir que tengas una mejor experiencia de navegación, puedas compartir contenido en redes sociales y para que podamos obtener estadísticas de los usuarios.<br><br>
...
<h3 class="pdch3">Entidad Responsable</h3>
<p class="ng-binding pdcp">La entidad responsable de la recogida, procesamiento y utilización de tus datos personales, en el sentido establecido por la Ley de Protección de Datos Personales es la página www.booxchange.com, propiedad de El Equipo BooxChange – .</p>

            <h3 class="pdch3">¿Qué son las cookies?</h3>
            ...
            <h3 class="pdch3">¿Qué tipos de cookies existen?</h3>
...
<td>No Exenta</td>
            ...
            <p class="ng-binding pdcp">Adicionalmente, en función de su objetivo, las cookies pueden clasificarse de la siguiente forma:</p>
            <h3 class="pdch3">Cookies de rendimiento</h3>
            ...
            <h3 class="pdch3">Cookies de geo-localización</h3>
            <p class="pdcp">Estas cookies son utilizadas para averiguar en qué país se encuentra cuando se solicita un servicio. Esta cookie es totalmente anónima, y sólo se utiliza para ayudar a orientar el contenido a su ubicación.</p>
            <h3 class="pdch3">Cookies de registro</h3>
            <p class="pdcp">Las cookies de registro se generan una vez que el usuario se ha registrado o posteriormente ha abierto su sesión, y se utilizan para identificarle en los servicios con los siguientes objetivos:</p>
            <p class="pdcp">Mantener al usuario identificado de forma que, si cierra un servicio, el navegador o el ordenador y en otro momento u otro día vuelve a entrar en dicho servicio, seguirá identificado, facilitando así su navegación sin tener que volver a identificarse. Esta funcionalidad se puede suprimir si el usuario pulsa la funcionalidad [cerrar sesión], de forma que esta cookie se elimina y la próxima vez que entre en el servicio el usuario tendrá que iniciar sesión para estar identificado.</p>
            <p class="pdcp">Comprobar si el usuario está autorizado para acceder a ciertos servicios, por ejemplo, para participar en un concurso.</p>
            ...
            <h3 class="pdch3">Cookies de analíticas</h3>
            <p class="ng-binding pdcp">Cada vez que un usuario visita un servicio, una herramienta de un proveedor externo genera una cookie analítica en el ordenador del usuario. Esta cookie que sólo se genera en la visita, servirá en próximas visitas a los servicios de
              El Equipo BooxChange
              para identificar de forma anónima al visitante. Los objetivos principales que se persiguen son:</p>
            <p class="pdcp">Permitir la identificación anónima de los usuarios navegantes a través de la cookie (identifica navegadores y dispositivos, no personas) y por lo tanto la contabilización aproximada del número de visitantes y su tendencia en el tiempo.<br>
            ...
            <p class="ng-binding pdcp">Importante: Salvo que el usuario decida registrarse en un servicio de
              El Equipo BooxChange, la cookie nunca irá asociada a ningún dato de carácter personal que pueda identificarle. Dichas cookies sólo serán utilizadas con propósitos estadísticos que ayuden a la optimización de la experiencia de los usuarios en el sitio.</p>

            <h3 class="pdch3">Cookies de publicidad</h3>
            <p class="ng-binding pdcp">Este tipo de cookies permiten ampliar la información de los anuncios mostrados a cada usuario anónimo en los servicios de
              El Equipo BooxChange. Entre otros, se almacena la duración o frecuencia de visualización de posiciones publicitarias, la interacción con las mismas, o los patrones de navegación y/o comportamientos del usuario ya que ayudan a conformar un perfil de interés publicitario. De este modo, permiten ofrecer publicidad afín a los intereses del usuario.</p>
            <h3 class="pdch3">Cookies publicitarias de terceros</h3>
            <p class="ng-binding pdcp">Además de la publicidad gestionada por las webs de
              El Equipo BooxChange
            ...
            <p class="ng-binding pdcp">Las empresas que generan estas cookies tienen sus propias políticas de privacidad. En la actualidad, las webs de
              El Equipo BooxChange
            ...
            <h3 class="pdch3">¿Cómo puedo deshabilitar las cookies en mi navegador?</h3>
            ...
            <p class="pdcp">Para ampliar esta información consulte las instrucciones y manuales de su navegador:</p>
            <p class="pdcp">Para más información sobre la administración de las cookies en Google Chrome:
              <a href="https://support.google.com/chrome/answer/95647?hl=es">https://support.google.com/chrome/answer/95647?hl=es</a>
            </p>
            <p class="pdcp">Para más información sobre la administración de las cookies en Internet Explorer:
            ...
            <p class="pdcp">Para más información sobre la administración de las cookies en Safari:
              <a href="http://www.apple.com/es/privacy/use-of-cookies/%20">http://www.apple.com/es/privacy/use-of-cookies/
              </a>
            </p>
            <p class="pdcp">Para más información sobre la administración de las cookies en Opera:
              <a href="http://help.opera.com/Windows/11.50/es-ES/cookies.html">http://help.opera.com/Windows/11.50/es-ES/cookies.html</a>
            </p>
            <p class="pdcp">Si desea dejar de ser seguido por Google Analytics visite:
            ...
            <p class="pdcp">Puede obtener más información sobre la publicidad online basada en el comportamiento y la privacidad online en el siguiente enlace:
              <a href="http://www.youronlinechoices.com/es/">http://www.youronlinechoices.com/es/</a>
            </p>
            <p class="pdcp">Protección de datos de Google Analytics:
              <a href="http://www.google.com/analytics/learn/privacy.html">http://www.google.com/analytics/learn/privacy.html</a>
            </p>
            <p class="pdcp">Cómo usa Google Analytics las cookies:
            ...
            <p class="ng-binding pdcp">Las webs de
              El Equipo BooxChange
            ...
            <p class="pdcp">Cuando se produzcan cambios significativos en esta Política de Cookies, estos se comunicarán a los usuarios bien mediante la web o a través de correo electrónico a los usuarios registrados.</p>
          </div>
